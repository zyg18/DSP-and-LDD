...
int main(int argc, char** argv)
{
  ...
  double*edge_dist=new double[A_num]();   //distribute to i rather than index
  ...
  double max_density;
  ofstream p;
  p.open("./energy/fw_"+data_in+".csv",ios::out|ios::trunc); 
  double sum_time=0;
  double E=0;
  //Frank-Wolfe
